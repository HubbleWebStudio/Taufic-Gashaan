...
Leer el mapping de pilares activos desde `../STATE-marketing.md` (sección "Pilares de contenido"). Cada pilar tiene asignada su carpeta de Drive en ese archivo.
...
# Colores de marca — leer desde ../MEMORY.md (sección "Sistema de Diseño" o "Paleta")
# El agente extrae los hex de MEMORY.md y los convierte a RGB antes de ejecutar este script.
# Ejemplo de conversión: COLOR_PRIMARIO = tuple(int(hex_str[i:i+2], 16) for i in (0, 2, 4))
COLOR_PRIMARIO = None     # hex extraído de MEMORY.md — color principal de la marca
COLOR_SECUNDARIO = None   # hex extraído de MEMORY.md — color de acento
COLOR_BASE = None         # hex extraído de MEMORY.md — color de fondo/neutro
...
### Sobre el logo
- Buscar en Drive: carpeta `../marketing/references/brand/` o en la carpeta del cliente en Drive (ver IDs en STATE-marketing.md)
