...
### Agregado
- Cápsula clonada desde `./agentes/hubble-marketing/` en versión v1.1 (ver entrada baseline más abajo).
...
### Propagación
- Instancia receptora: `./proyectos/taufic_gashaan/hubble-marketing/`
