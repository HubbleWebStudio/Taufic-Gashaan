...
## [Clonado en taufic_gashaan] — 2026-04-27

### Agregado
- Cápsula clonada desde `./agentes/hubble-web-designer/` en versión v3.2 (ver entrada baseline más abajo).

### Razón
Onboarding del cliente Taufic Gashaan. Los 3 agentes se clonan desde el inicio para tenerlos disponibles cuando se necesiten.

### Propagación
- Instancia receptora: `./proyectos/taufic_gashaan/hubble-web-designer/`
